...
public class TypeName {
  ...
  static TypeName get(TypeMirror mirror,
    ...
    return mirror.accept(new SimpleTypeVisitor7<TypeName, Void>() {
      ...
      @Override public TypeName visitTypeVariable(org.openjdk.javax.lang.model.type.TypeVariable t, Void p) {
        return TypeVariableName.get(t, typeVariables);
      }

      @Override public TypeName visitWildcard(org.openjdk.javax.lang.model.type.WildcardType t, Void p) {
